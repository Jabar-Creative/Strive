...
| `F-05` | Deploy staging otomatis dari main (web, api, ai, … | A | W1 | 1,5 | `review` | #149 | 2026-09-25 | Workflow CD di #149. Deploy pertama run 36114955174 gagal: image api crash `MODULE_NOT_FOUND` reflect-metadata; migrasi dan cek skema lulus; worker, ai, dan web tidak naik. Perbaikan image di branch `f-05-perbaiki-image-api`. Bukan `done`: V1–V13 TIDAK TERBUKTI. Skema staging hanya dibaca. DoD di CLAUDE.md tidak dikembalikan — pengumuman Dev A. |
