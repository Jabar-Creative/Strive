...
>
> **Catatan rekonsiliasi (2026-09-16):** angka di bawah HANYA mencerminkan F-08 pindah dari
> `todo` ke `review` di branch ini. Baris F-06/F-09 di branch ini masih menampilkan `review`
> (bukan `done`) karena branch ini bercabang dari `origin/main` SEBELUM PR #36/#20 (koreksi
> staleness itu) merge — lihat PR #36 dan #20 untuk status sungguhannya. Siapa pun yang
> merge PR ini terakhir dari tumpukan #20/#30/#31/#36/#40/#41/#42/#43: hitung ulang seluruh
> tabel ini dari baris item di `main` terkini (AGENTS.md aturan 11), JANGAN pilih salah satu
> sisi angka di bawah.
