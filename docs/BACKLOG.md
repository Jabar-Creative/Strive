...
| `F-05` | Deploy staging otomatis dari main (web, api, ai, … | A | W1 | 1,5 | `review` | #149 | 2026-09-25 | Workflow CD di #149. Image api diperbaiki #150. Deploy 36118019993 smoke lulus. Bukan `done`: V1–V13 TIDAK TERBUKTI. IP Better Auth sempat satu ember; hop diukur dari log, bukan tebakan. DoD di CLAUDE.md tidak dikembalikan. |
