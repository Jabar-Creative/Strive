...
| `F-05` | Deploy staging otomatis dari main (web, api, ai, … | A | W1 | 1,5 | `in_progress` | — | 2026-09-25 | Workflow deploy sedang ditulis. Belum ada yang di-deploy; V1–V13 belum terbukti. |
